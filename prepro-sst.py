...
def extract_filled_tree(cur_data, fillnum=200, word2idx=None):
    ...
    tree = cur_data
    input_, treestr, t_input, t_treestr, t_par_leaf = extract_tree_data(tree, max_degree=2, only_leaves_have_vals=False,
                                                                        word2idx=word2idx)
...
def extract_tree_data(tree, word2idx=None, max_degree=2, only_leaves_have_vals=True):
    ...
    return (np.array(leaf_emb, dtype='int32'), np.array(tree_str, dtype='int32'), np.array(t_leaf_emb, dtype='int32'),
